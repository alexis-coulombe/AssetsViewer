<template>
    ...
    <div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
        ...
        <div class="w-1/2 pl-2 md:pl-0">
            <span class="text-gray-100 xl:text-xl font-bold">
                Admin Dark Mode
            </span>
        </div>
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-gray-900 z-20" id="nav-content">
            <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                <li class="mr-6 my-2 md:my-0 cursor-pointer">
                    <router-link to="/" exact class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-100 border-b-2 border-gray-900  hover:border-purple-400">
                        <i class="fas fa-home fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Home</span>
                    </router-link>
                </li>
                <li class="mr-6 my-2 md:my-0 cursor-pointer">
                    <router-link to="/wallet" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-100 border-b-2 border-gray-900  hover:border-purple-400">
                        <i class="fas fa-wallet fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Wallet</span>
                    </router-link>
                </li>
                <li class="mr-6 my-2 md:my-0 cursor-pointer">
                    <router-link to="/currency/btc" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-100 border-b-2 border-gray-900  hover:border-purple-400">
                        <i class="fab fa-bitcoin fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">BTC</span>
                    </router-link>
                </li>
                <li class="mr-6 my-2 md:my-0 cursor-pointer">
                    <router-link to="/currency/eth" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-100 border-b-2 border-gray-900  hover:border-purple-400">
                        <i class="fab fa-ethereum fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">ETH</span>
                    </router-link>
                </li>
                <li class="mr-6 my-2 md:my-0 cursor-pointer">
                    <router-link to="/currency/bch" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-100 border-b-2 border-gray-900  hover:border-purple-400">
                        <i class="fas fa-coins fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">BCH</span>
                    </router-link>
                </li>
            </ul>
        </div>
